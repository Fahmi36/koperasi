					...
					<div class="form-example-int form-horizental mg-t-15">
						<div class="form-group">
							<div class="row">
								...
								<div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
									<div class="nk-int-st">
										<input type="text" name="Kelompok" class="form-control input-sm" placeholder="Masukkan Kelompok">
									</div>
								</div>
							</div>
						</div>
					...
					<div class="form-example-int form-horizental">
						<div class="form-group">
							<div class="row">
								...
								<div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
									<div class="nk-int-st">
										<input type="number" name="telp" class="form-control input-sm" placeholder="Masukkan No. Telp">
									</div>
								</div>
							</div>
						</div>
					...
					<div class="form-example-int form-horizental mg-t-15">
						<div class="form-group">
							<div class="row">
								...
								<div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
									<div class="nk-int-st">
										<input type="number" name="norek" class="form-control input-sm" placeholder="Masukkan No. Rekening">
									</div>
								</div>
							</div>
						</div>
