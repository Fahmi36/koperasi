						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="breadcomb-wp">
								...
								<div class="breadcomb-ctn">
									<h2>Halaman Setoran</h2>
									<p>FORMULIR SETORAN KOPERASI PKK MELATI JAYA</p>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="form-example-wrap mg-t-30">
					...
					<div class="form-example-int form-horizental mg-t-15" id="angsuranpokok">
						<div class="form-group">
							<div class="row">
								<div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
									<label class="hrzn-fm">Angsuran :</label>
								</div>
								<div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
									<div class="nk-int-st">
										<input type="number" name="angsuran" class="form-control input-sm" placeholder="Masukkan Besar Pinjaman">
									</div>
								</div>
							</div>
						</div>
					...
					<div class="form-example-int form-horizental mg-t-15" id="jasapokok">
						<div class="form-group">
							<div class="row">
								<div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
									<label class="hrzn-fm">Jasa :</label>
								</div>
								<div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
									<div class="nk-int-st">
										<input type="number" name="jasa" class="form-control input-sm" placeholder="Masukkan Jasa">
									</div>
								</div>
							</div>
						</div>
...
<!-- 					<div class="form-example-int form-horizental mg-t-15">
						<div class="form-group">
							<div class="row">
								...
								<div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
									<div class="nk-int-st">
										<input type="text" disabled="" name="jumlah" class="form-control input-sm" placeholder="Jumlah">
									</div>
								</div>
							</div>
						</div>
